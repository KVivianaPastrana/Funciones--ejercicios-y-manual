...
function  calcularEdad  (panioNa, panioAct) {
    anioNa = panioNa;
    anioAct = panioAct;
...
function   compararEdades (pedadPersona1, pedadPersona2, pedadPersona3) {
...
function  promedioEdades (pedadPersona1, pedadPersona2, pedadPersona3) {
    return (pedadPersona1 + pedadPersona2 + pedadPersona3) / 3;
};

 function  promedioMayoriaEdad (pedadPersona1, pedadPersona2, pedadPersona3) {
