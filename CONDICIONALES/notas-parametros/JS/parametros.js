 function calcularPorcentajeNota1 (nota1) {
...
function  calcularPorcentajeNota2 (nota2) {
...
console.log("Porcentaje nota 2: " + nota2);
 ...
 function calcularPorcentajeNota3(nota3) {
...
function sumaDeLosTresProcentajes  (porcentaje1, porcentaje2, porcentaje3) {
...
function compararNotas (sumaProcentajes) {
